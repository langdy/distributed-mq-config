...
public class CustomizeCron implements Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = -6430845380076436953L;
    ...
    public String toCronString() {
        return this.seconds + SPACE + this.minutes + SPACE + this.hours + SPACE + this.daysOfMonth
                + SPACE + this.months + SPACE + this.daysOfWeek;
    }
