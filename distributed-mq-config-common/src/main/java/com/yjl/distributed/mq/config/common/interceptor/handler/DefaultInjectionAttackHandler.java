...
public class DefaultInjectionAttackHandler implements InjectionAttackHandler {
	...
	private static final String EVENTS =
			"((?i)onload|onunload|onchange|onsubmit|onreset" + "|onselect|onblur|onfocus|onkeydown|onkeypress|onkeyup"
	...
	// XSS
	///////////////////////////////////////////////////////////////////////////
	private static final Pattern XSS_REGEX_PATTERN = Pattern.compile(XSS_REGEX, Pattern.CASE_INSENSITIVE);
	///////////////////////////////////////////////////////////////////////////
	// 特殊字符
	///////////////////////////////////////////////////////////////////////////
	...
	public void attackHandle(HttpServletRequest request, HttpServletResponse response, String parameters)
		...
		try (PrintWriter out = response.getWriter()) {
			out.print(JsonUtils
					.toCustomizationJson(new ResponseEntity<Object>().badRequest("请求内容包含非法字符,原请求内容:\n" + parameters)));
		}
	}
