package com.yjl.distributed.mq.config.common.regex;
...
public final class RegexType implements Serializable {
     ...
     * </p>
     */
    public static final String SQUARE_ROOT_IN_NUMBER =
            "(^\\d+(.[0-9]*)?[0-9]$)|(^\\d+(.[0-9]*)?[1-9]$)|^\\d$";
    /**
    ...
    // 2016-12-19 15:59:45
    private static final String DATE_YYYY_MM_DD_HH_MM_SS =
    ...
    private static final String DATE_YYYY_MM_DD_HH_MM_SS_3 =
            "(((19|20)[0-9]{2})(0?[1-9]|1[012])(0?[1-9]|[12][0-9]|3[01])([01]?[0-9]|2[0-3])[0-5][0-9][0-5][0-9])";
    // 2016/12/19
    private static final String DATE_YYYY_MM_2 =
            "(((19|20)[0-9]{2})/(0?[1-9]|1[012])/(0?[1-9]|[12][0-9]|3[01]))";
    // 20161219
    private static final String DATE_YYYY_MM_3 =
            "(((19|20)[0-9]{2})(0?[1-9]|1[012])(0?[1-9]|[12][0-9]|3[01]))";
    /**
     * 基本日期
     * <p>
     ...
     * </p>
     */
    public static final String DATE_BASIC = DATE_YYYY_MM_DD_HH_MM_SS + "|" + DATE_YYYY_MM_DD + "|"
            + DATE_YYYY_MM_DD_HH_MM_SS_2 + "|" + DATE_YYYY_MM_2 + "|" + DATE_YYYY_MM_DD_HH_MM_SS_3
            + "|" + DATE_YYYY_MM_3;
